...
import { Route as RouteIcon, Plus, Check, Calendar, Clock, Users, MapPin, MessageSquare } from 'lucide-react-native';
  ...
  const renderHeader = () => (
    <View style={styles.header}>
      ...
      <View style={styles.decorativeElement}>
        <Image 
          source={{ uri: 'https://www.spuntidiviaggio.it/wp-content/uploads/2024/05/cosa-vedere-museo-egizio-di-torino-nuovo-allestimento-bicentenario-visitare-spuntidiviaggio.jpg' }}
